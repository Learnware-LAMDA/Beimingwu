export default {
  ...
  What: {
    Title: "学件是什么？",
    Description:
      "学件由性能优良的机器学习模型和描述模型的规约组成。规约刻画了模型的能力，使得模型在未来能够根据用户需求被充分识别和复用，以满足用户需求。",
  ...
  Function: {
    Title: "北冥坞系统的主要功能是什么？",
    SearchAndDeploy:
      "查搜部署学件：当用户提交任务需求后，学件基座系统会根据学件规约推荐对用户任务有帮助的学件并指导用户进行部署和复用。",
    Submit:
      "提交优质学件：开发者可以自发地提交各式各样的学件到学件基座系统，而系统会对这些学件进行质量检查和进一步的组织。",
  },
  Feature: {
    Title: "系统特性",
    Feature1: {
