...
class TestUser(unittest.TestCase):
    ...
    #     result = testops.url_request("user/list_learnware", {"page": 0, "limit": 10, "is_verified": False}, headers=headers)
    ...
    #     self.assertEqual(result["code"], 0)
    #     result = testops.url_request("user/list_learnware", {"page": 0, "limit": 10, "is_verified": True}, headers=headers)
