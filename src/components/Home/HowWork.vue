  ...
  <div class="mx-auto md:pb-30 <md:pb-20 md:px-10 max-w-1200px w-1/1">
    <div class="<md:px-5">
      ...
      <p class="text-gray-500">
        ...
        trained machine learning models. The users need machine learning services but usually have
        only limited data and lack machine learning knowledge and skills. The learnware market
        accepts/buys well-performed trained models from developers, accommodates them in the market,
        and provides/sells services to users via identifying and reusing learnwares to help users
        tackle their present tasks
      </p>
    </div>
