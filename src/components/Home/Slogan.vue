...
<template>
  <div class="xl:py-35 lg:py-30 md:py-20 <md:py-10 text-center text-white" style="background: #6200EE; background: -webkit-linear-gradient(to right, #673AB7, #6200EE); background: linear-gradient(to right, #673AB7, #6200EE);">
    <big-title>
